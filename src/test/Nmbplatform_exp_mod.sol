...
interface StakingRewardFixedAPY is IERC20 {
    ...
    function rewardsPaymentToken() external view returns (address);
...
contract ContractTest is Test {
    ...
    function setUp() public {
        ...
        emit log_named_address("stakingToken", stakingReward1.stakingToken());
        emit log_named_address("rewardsToken", stakingReward1.rewardsToken());
        emit log_named_address("rewardsPaymentToken", stakingReward1.rewardsPaymentToken());
        if (stakingReward1.usePriceFeeds()) {
            emit log_named_string("usePriceFeeds", "true");
        }
    }
